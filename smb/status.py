...
class StatusError(Exception):
    ...
    # TODO: Not sure if it will  use `NotImplemented` rather than the value of class variable. Test.
    def __init__(self, description: Optional[str] = None):
        super().__init__(description or self.DESCRIPTION)

    @classmethod
    def from_status(cls, status: Status) -> StatusError:
        ...


class StatusAbandonedError(StatusError):
    DESCRIPTION = 'blabla'
